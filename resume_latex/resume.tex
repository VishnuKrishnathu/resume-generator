    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                % \item Worked closely with operational teams to \textbf{automate processes} and reduce workload.
                % \item Built a \textbf{code compiler} to manage over \textbf{500 concurrent requests}.
                % \item Created \textbf{CI/CD pipelines} employing \textbf{Github Actions }and \textbf{AWS Codepipeline}.
                % \item Spearheaded sprint planning aligning with business requirements for timely product delivery.
